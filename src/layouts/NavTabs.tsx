...
/**
 * Navigation that looks like the `Tabs` control the dashboard already uses,
 * because these are exactly that — a switch between screens held in state,
 * not an address. Nothing here is addressable, and that is the point: this
 * app has no routes for a link to point at.
 *
